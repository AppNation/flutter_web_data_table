...
class CustomPaginatedDataTable extends StatefulWidget {
  ...
  CustomPaginatedDataTable({
    ...
    this.controller,
    this.primary,
    this.onPageIncreased,
    this.onPageDecreased,
  ...
  /// Triggers when page index increased with pushing to right arrow button
  final VoidCallback? onPageIncreased;

  /// Triggers when page index decreased with pushing to left arrow button
  final VoidCallback? onPageDecreased;

  /// Specifies the index of the page. It displays incremented by one on the UI
  final int pageIndex;
...
class PaginatedDataTableState extends State<CustomPaginatedDataTable> {
  ...
  Widget build(BuildContext context) {
    ...
    footerWidgets.addAll(<Widget>[
      ...
      IconButton(
        onPressed: widget.onPageDecreased,
